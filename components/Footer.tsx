      ...
      <div className="container">
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerCol}>
            <h4>Contact</h4>
            <ul>
              <li>8105 Odessa Pl Unit B</li>
              <li>Douglasville, GA 30134</li>
              <li>(470) 535-7638</li>
          ...
          <div className={styles.footerCol}>
            ...
            <div className={styles.socialLinks}>
              <a href="https://www.facebook.com/bodysbybert" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Facebook">
